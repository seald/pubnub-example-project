...
import { AppContext } from '../stores/AppContext.jsx'
  ...
  const handleSignupSubmit = useCallback(
    async e => {
      ...
      try {
        ...
        const { currentUser, signupJWT } = await User.createAccount({ emailAddress, password, name })
        await createIdentity({ userId: currentUser.id, password, signupJWT })
